...
COPY ../conf/example-apache-2.conf /usr/local/apache2/sites-available/example1.conf
COPY ../conf/example-unknown-web-app.conf /usr/local/apache2/sites-available/example2.conf
...
COPY ../html/unknown-index.html /usr/local/apache2/htdocs/unknown/index.html
