...
def hostname_info_model(api):
    ...
    'hostname': fields.String(required=True, description='Hostname of the scanned device', example='www.example.com'),
    ...
    'latest_version': fields.String(required=False, description='Latest available version of the web application', example='6.2.3'),
    'latest_cycle_version': fields.String(required=False, description='Latest version of the web application regarding the current cycle version (MAJOR.MINOR)', example='5.1.8'),
    'eol': fields.Boolean(required=False, description='Flag saying whether the current version reached EOL support.', example=True),
    'eol_date': fields.String(required=False, description='End of Life date of the web application', example='2019-04-13')
})
